...
The resources provided in this sprint contain a lot of prebuilt code. It is in your benefit if you do not directly reference this code, instead, utilize your other given and familiar resources(links, walkthroughs, tutorials, fellows, etc,.). Your restraint will pay dividends for your education and comprehension of this powerful library.

Enjoy.

## Basic Requirements

Follow along with these tutorials to help you get started with D3
...
Unlike other sprints which are test driven, you will have the freedom to get creative with your pair in this sprint. You and your pair will be presenting your visualizations during the solution lecture time - this is the first of many occasions you will be able to present your work to your peers. 
...
####Step 3
- [ ] 
Choose any visualization of your choice from this [site](https://github.com/mbostock/d3/wiki/Gallery).
...
- [ ] Format and replace the new data on one of your existing graphs.
